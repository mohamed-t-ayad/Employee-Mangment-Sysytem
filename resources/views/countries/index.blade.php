        ...
        <div class="col">
            <form method="GET" action="{{ route('countries.index')}}">
                <div class="input-group mb-1">
                    <input type="search" class="form-control mr-1 rounded" name="search" placeholder="search countries" >
                ...
                <tbody class="">
                  @foreach ($countries as $country )
                    <tr>
                        ...
                        <td>
                            <a href="{{route('countries.edit',$country->id)}}" class="btn btn-sm btn-info"><i class="far fa-edit"></i></a>
                        </td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
              <a href="{{route('countries.create')}}" class="btn btn-sm btn-primary float-left">
