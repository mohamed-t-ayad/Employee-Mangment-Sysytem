            ...
            <li class="nav-item">
                ...
                <div id="collapseSystem" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('departments.index')}}">Depaetment</a>
                        <a class="collapse-item" href="{{route('cities.index')}}">City</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - USer mangment Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUserMangment"
                    aria-expanded="true" aria-controls="collapseUserMangment">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>User Mangment</span>
                </a>
                <div id="collapseUserMangment" class="collapse" aria-labelledby="headingUtilities"
