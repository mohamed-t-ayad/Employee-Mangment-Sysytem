        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-left">
                    ...
                    <a href="{{route('departments.index')}}" class="btn btn-sm float-right text-primary"><i class="fas fa-home"></i> Departments</a>
                </div>
                <div class="card-body">
            ...
            <div class=" mt-1 text-left">
                <form method="POST" action="{{route('departments.destroy',$department->id)}}">
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-danger"><i class="far fa-trash-alt"></i> Delete {{$department->name}}</button>
                </form>
            </div>
        </div>
    </div>
